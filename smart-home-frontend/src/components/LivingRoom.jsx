...
const LivingRoom = () => {
  ...
  useEffect(() => {
    const fetchDevices = async () => {
      try {
        const response = await axios.get('http://127.0.0.1:5000/mock/devices/location/living-room', {
          headers: {
        ...
        setError('Error fetching living room devices');
        console.error('Error fetching living room devices:', error);
      }
    };
