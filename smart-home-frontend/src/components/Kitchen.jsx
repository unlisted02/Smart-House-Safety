...
const Kitchen = () => {
  ...
  useEffect(() => {
    const fetchDevices = async () => {
      try {
        const response = await axios.get('http://127.0.0.1:5000/mock/devices/location/kitchen', {
          headers: {
        ...
        setError('Error fetching kitchen devices');
        console.error('Error fetching kitchen devices:', error);
      }
    };
